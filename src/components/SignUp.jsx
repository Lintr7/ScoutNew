...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[rgb(0,0,0)] dark:bg-[rgb(0,0,0)]">
      <div className="max-w-md w-full space-y-8">
        <div className="relative h-full rounded-2xl border border-transparent p-px md:rounded-2xl md:p-px">
              <GlowingEffect
                ...
                inactiveZone={0.01}
              />
        <div className="bg-[rgb(10,10,12)] dark:bg-[rgb(10,10,12)] py-8 px-4 shadow-lg sm:rounded-xl sm:px-10 dark:border-zinc-700">
          ...
          <br/>
          {error && (
            <div className="mb-4 p-3 bg-red-900/30 dark:bg-red-900/30 border border-red-400 dark:border-red-600 text-red-700 dark:text-red-400 rounded">
              {error}
            </div>
          )}
