...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[150em] flex-col items-center justify-center overflow-hidden bg-transparent w-full rounded-md z-0",
        className
      )}>
      <div
        ...
        <div
          className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-transparentblur-2xl"></div>
        <div
          className="absolute top-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
        <div
          className="absolute inset-auto z-50 h-41 w-[34rem] -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
        ...
        <div
          className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-[rgb(1,3,33)]"></div>
      </div>
