  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-[rgba(0,0,0,0.3)] backdrop-blur-3xl",
        className
      )}>
      {children}
    </motion.div>
    ...
    <motion.div
      ...
      {items.map((item, idx) => (
        <a
          ...
          onClick={onItemClick}
          className="relative px-4 py-2 font-bold text-neutral-300"
          key={`link-${idx}`}
          href={item.link}>
          {hovered === idx && (
            <motion.div
  ...
  return (
    <a
      ...
      <img
        ...
        width={30}
        height={30} />
      <span style={{ fontFamily: "'SF Mono', Monaco, monospace" }} className="text-2xl text-[#9167fb]">Scout</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent font-bold shadow-none text-white",
