  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-white/80 dark:bg-[rgba(0,0,0,0.3)] backdrop-blur-3xl",
        className
      )}>
      {children}
    </motion.div>
      ...
      {items.map((item, idx) => (
        <a
          ...
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-gray-100 dark:bg-gray-100/10" />
          )}
  ...
  return (
    <a
      ...
      <img
        ...
        width={30}
        height={30} />
      <span style={{ fontFamily: "'SF Mono', Monaco, monospace" }} className="text-2xl font-black dark:text-[#9167fb]">Scout</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent font-bold shadow-none dark:text-white",
