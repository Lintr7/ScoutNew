  ...
  return (
    <div
      ...
      <div className="absolute top-20 left-1/2 -translate-x-1/2 z-40">
        <div className="h-40 w-px bg-gradient-to-b from-transparent via-cyan-500 to-transparent animate-move">
  ...
  return (
    <div
      className={cn("h-[15rem] md:h-[20rem] rounded-xl z-40", className, showGradient &&
        "bg-[rgba(40,40,40,0.40)] [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]")}>
      {children}
    </div>
  );
};
