...
VALID_SYMBOLS = {
    ...
    "BMBL", "MTCH", "GRAB", "LCID", "CROX", 'IBKR', 'SCCO', 'ORLY', 'CRH', 'MSTR', 'VRT', 'EPD',
    "PSKY", "OMC", "SIRI", "IPG", "H", "IHG", "WH", "CHH", "MGM", "WYNN",
    "CZR", "LVS", "NCLH", "SIX", "UAL", "AAL", "ADM", "BG", "DOW", "LYB",
    "NUE", "STLD", "PKG", "WRK", "APTV", "ALV", "XPO", "HRI", "M", "KSS",
    "JWN", "VFC", "PVH", "UAA", "SIG", "CPRI", "PLNT", "DKS", "QSR", "DRI",
    "WEN", "JACK", "SAM", "NOK", "ERIC", "AWK", "WCN", "ATGE", "LOPE", "VAC",
    "HGV", "CAR", "HTZ", "CBRE", "JLL", "BCO", "SCI", "CSV", "GT", "HBI",
    "ELF", "COTY", "ODP"
}
