...
VALID_SYMBOLS = {
    ...
    'BKNG', 'PGR', 'LMT', 'RTX', 'DUK', 'SO', 'EL', 'SHW', 'TJX',
    ...
    'AEP', 'TDG', 'ADI', 'CEG', 'PSX', 'SLB', 'PH', 'WM', 'COIN',
    'AOS', 'BABA', 'UBER', 'OXY', 'FHN', 'ENPH', 'APH', 'SYK', 'BYND',
    'BDX', 'ACN', 'NOC', 'COP', 'DASH', 'KKR', 'MSI', 'ETR', 'HAL',
    ...
    'HWM', 'TEL', 'HOOD', 'AJG', 'APD', 'GD', 'ESS', 'XYZ',
    ...
    'MTB', 'CTSH', 'SNOW', 'MDB', 'SPOT', 'LULU', 'ULTA',
