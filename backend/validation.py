...
VALID_SYMBOLS = {
    ...
    "BMBL", "MTCH", "GRAB", "LCID", "CROX", 'TM', 'AZN', 'HSBC', 'HDB', 'SONY', 'SAN', 'BHP', 'TTE',
    'BUD', 'SNY', 'IBKR', 'BTI', 'SCCO', 'ENB', 'GSK', 'BMO',
    'AEM', 'ORLY', 'CRH', 'RACE', 'MSTR', 'VRT', 'BAESY', 'DB',
    'INFY', 'PWR', 'EPD', 'MBG', 'TRI', 'SIEGY',
}
